...
export default {
  ...
  setup() {
    ...
    const loadBalance = async () => {
      try {
        const response = await fetch(`https://ko-forex.shop/api/balance/${currentUserId.value}`, {
          method: 'GET',
          headers: {
    ...
    const loadExchangeRate = async () => {
      try {
        const response = await fetch(`https://ko-forex.shop/api/exchange/realtime/${selectedCurrency.value}`)
    ...
    const loadTransactions = async () => {
      try {
        ...
        const response = await fetch(
          `https://ko-forex.shop/api/transaction/history/${currentUserId.value}?${params}`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
