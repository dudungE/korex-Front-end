...
const fetchSupportedCurrencies = async () => {
  ...
  try {
    const response = await fetch('https://ko-forex.shop/api/currency/currencies', {
      method: 'GET',
      headers: {
...
const fetchUserBalances = async () => {
  ...
  try {
    const response = await fetch(`https://ko-forex.shop/api/balance/${userId}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      }
...
const verifyRecipientName = async () => {
  ...
  try {
    const response = await fetch("https://ko-forex.shop/api/user/exists?name=" + encodeURIComponent(recipientName.value), {
      method: "GET"
    })
...
const verifyRecipientPhone = async () => {
  ...
  try {
    const response = await fetch("https://ko-forex.shop/api/user/verify-recipient", {
      method: "POST",
...
const executeTransfer = async () => {
  ...
  try {
    ...
    const response = await fetch('https://ko-forex.shop/api/transfer/execute', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
